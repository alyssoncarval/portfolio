...
import Alysson_Carvalho from "@/public/Alysson_Carvalho.jpg";
    ...
    <div className="divide-y divide-gray-100 dark:divide-gray-700">
      ...
      <div className="items-center space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
        <div className="flex flex-col items-center pt-8">
          <Image
            alt="Picture of Alysson Carvalho"
            src={Alysson_Carvalho}
          ...
          <div className="flex space-x-5 pt-6">
            <a href="https://github.com/alyssoncarval" target="_blank">
              <svg
            ...
            <a href="https://www.linkedin.com/in/alyssoncarval" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
            ...
            <a href="mailto:alyssonper@gmail.com" target="_blank">
              <svg
                viewBox="0 0 1024 1024"
                fill="currentColor"
                className="w-8 h-8 text-teal-500 hover:text-teal-600"
        ...
        <div className="prose max-w-none prose-lg pt-8 pb-7 dark:prose-invert xl:col-span-2">
          ...
          <p>
            I offer solutions in digital software development services.
          </p>
          <p>
